...
print(f'✅ Graph created: {node_features.shape[0]} nodes, {edge_index.shape[1]} edges')
...
detector.fit(X, edge_index=edge_index.numpy().T, device='cpu')
train_time = time.time() - start
print(f'✅ Training completed in {train_time:.2f}s')
status = 'trained' if detector.gnn_model is not None else 'skipped'
print(f'✅ GNN model: {status}')
print(f'✅ GNN weight: {detector.gnn_weight:.4f}')
print(f'\n✅ GNN fix successful!')
